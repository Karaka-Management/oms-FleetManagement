...
return [
    ...
    '^.*/fleet/vehicle(\?.*|$)$' => [
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiController:apiVehicleCreate',
            'verb'       => RouteVerb::PUT,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
        ...
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiController:apiVehicleUpdate',
            'verb'       => RouteVerb::SET,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
    ...
    '^.*/fleet/vehicle/file(\?.*|$)$' => [
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiController:apiMediaAddToVehicle',
            'verb'       => RouteVerb::PUT,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
    ...
    '^.*/fleet/driver(\?.*|$)$' => [
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiDriverController:apiDriverCreate',
            'verb'       => RouteVerb::PUT,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
        ...
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiDriverController:apiDriverUpdate',
            'verb'       => RouteVerb::SET,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
    ...
    '^.*/fleet/driver/file(\?.*|$)$' => [
        [
            'dest'       => '\Modules\FleetManagement\Controller\ApiDriverController:apiMediaAddToDriver',
            'verb'       => RouteVerb::PUT,
            'csrf'       => true,
            'active'     => true,
            'permission' => [
