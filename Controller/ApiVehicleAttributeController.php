...
final class ApiVehicleAttributeController extends Controller
{
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeTypeL11nUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeTypeL11nDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeTypeUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeTypeDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeValueUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeValueL11nUpdate(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
     ...
     * @since 1.0.0
     */
    public function apiVehicleAttributeValueL11nDelete(RequestAbstract $request, ResponseAbstract $response, mixed $data = null) : void
    {
